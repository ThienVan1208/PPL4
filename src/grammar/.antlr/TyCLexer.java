...
public class TyCLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"AUTO", "BREAK", "CASE", "CONTINUE", "DEFAULT", "ELSE", "FLOAT", "FOR", 
			"IF", "INT", "RETURN", "STRING", "STRUCT", "SWITCH", "VOID", "WHILE", 
			...
			"EXP", "ESC", "STRING_LIT", "ILLEGAL_ESCAPE", "UNCLOSE_STRING", "ID", 
			"BLOCK_COMMENT", "LINE_COMMENT", "WS", "ERROR_TOKEN"
		};
	}
	...
	private void ERROR_TOKEN_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 3:
			 self.text = "Error Token " + self.text 
			break;
		}
	}
